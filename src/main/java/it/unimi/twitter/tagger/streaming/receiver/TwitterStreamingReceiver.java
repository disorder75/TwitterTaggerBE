...
public class TwitterStreamingReceiver {
	...
	public static void twitterStream(String token, String url, TwitterStreamedData<String> queue) throws IOException, URISyntaxException, ParseException, JSONException, InterruptedException, HttpException {
		...
		if (null != bearerToken) {
			...
			rules.put("economia italiana OR mercati OR economia OR #borsa OR #economiaitaliana OR #economiaitalia OR #sviluppo OR #investimenti -is:retweet -is:reply -has:links lang:it","rule_italia_003");
			rules.put("industriali OR industria italiana OR industria OR fabbriche OR produzione OR #industria OR #confindustria OR #industriali OR #industriaitaliana OR #aziende -is:retweet -is:reply -has:links lang:it","rule_italia_004");
			rules.put("istruzione OR #istruzione OR #scuola OR #scuolapubblica -is:retweet -is:reply -has:links lang:it","rule_italia_005");
			rules.put("occupazione OR disoccupazione OR #occupazione OR #lavoro OR #disoccupazione -is:retweet -is:reply -has:links lang:it","rule_italia_006");
			rules.put("pensioni OR lavoro OR welfare OR #pensioni OR #pensionati OR #pensionamento OR #quotacento OR #contributivo -is:retweet -is:reply -has:links lang:it","rule_italia_007");
			rules.put("immigrazione OR clandestini OR sbarchi OR accoglienza OR #accoglienza OR #immigrazione OR #clandestini OR #sbarchi -is:retweet -is:reply -has:links lang:it","rule_italia_008");
			rules.put("natalita OR mortalita OR nascite OR popolazione OR #popolazione OR #mortalita OR #natatalita OR #nascite -is:retweet -is:reply -has:links lang:it","rule_italia_009");
			rules.put("invasione OR sbarchi OR clandestini OR immigrazione OR emigrazione OR #sbarchi OR #invasioni OR #immigrazione OR #emigrazione OR #clandestini OR #sbarchi -is:retweet -is:reply -has:links lang:it","rule_italia_010");
			rules.put("vaccini OR scienza OR ricerca OR laboratori OR ricercatori OR #vaccini OR #ricercatori OR #scienza OR #innovazione OR #ricerca OR #cervelli OR #laboratori -is:retweet -is:reply -has:links lang:it","rule_italia_011");
			rules.put("pianeti OR cosmo OR galassia OR spazio OR stelle OR alieni OR universo OR #alieni OR #pianeti OR #galassia OR #spazio OR #stelle OR #universo OR #cosmo -is:retweet -is:reply -has:links lang:it","rule_italia_012");
			rules.put("malattie OR cancro OR terapie OR dottori OR ospedali OR #cancro OR #terapie OR #dottori OR #ospedali OR #malattie OR #alzheimer -is:retweet -is:reply -has:links lang:it","rule_italia_013");
			rules.put("bambini OR asili OR infanzia OR #asili OR #infanzia OR #bambini -is:retweet -is:reply -has:links lang:it","rule_italia_014");
			rules.put("ingegneria OR informatica OR tecnologia OR #ingegneria OR #informatica OR #tecnologia OR #innovazione -is:retweet -is:reply -has:links lang:it","rule_italia_015");
			rules.put("formazione OR didattica OR medie OR superiori OR laurea OR #didattica OR #formazione OR #dad OR #scuolemedie OR #scuolesuperiori OR #univerisita OR #laurea OR #formazioneadistanza -is:retweet -is:reply -has:links lang:it","rule_italia_016");
			rules.put("criminalita OR carceri OR delinquenza OR illegalita OR giustizia OR #giustizia OR #criminalita OR #carceri OR #illegalita OR #delinquenza -is:retweet -is:reply -has:links lang:it","rule_italia_017");
			rules.put("olimpiadi OR #olimpiadi -is:retweet -is:reply -has:links lang:it","rule_italia_018");
			rules.put("campionato OR #campionato OR #calcio -is:retweet -is:reply -has:links lang:it","rule_italia_019");
